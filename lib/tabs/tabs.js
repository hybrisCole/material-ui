...
var Tabs = React.createClass({
  ...
  render: function render() {
    ...
    var left = 'calc(' + width + '*' + this.props.selectedIndex + ')';
    ...
    var inkBar = this.props.selectedIndex !== -1 ? React.createElement(InkBar, {
      left: left,
      width: width,
  ...
  _handleTabTouchTap: function _handleTabTouchTap(value, e, tab) {
    ...
    if (valueLink.value && valueLink.value !== value || this.props.selectedIndex !== tabIndex) {
  ...
  _getSelected: function _getSelected(tab, index) {
    var valueLink = this.getValueLink(this.props);
    return valueLink.value ? valueLink.value === tab.props.value : this.props.selectedIndex === index;
  }
